                ...
                <div class="records--list" data-title="User List">
                    <table id="recordsListView">
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="btn-link">{{$user->surname}}</a></td>
                            <td><a href="#" class="btn-link">{{$user->national_id}}</a></td>
                            <td>{{$user->employee_id}}</td>
                            <td>{{$user->email}}</td>
                            <td>
                                <div class="dropleft"><a href="#" class="btn-link" data-toggle="dropdown"><i
                                                class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu"><a href="{{route('edit_user',['id'=>$user->id])}}" class="dropdown-item">Edit</a>
                                        <a href="{{route('delete_user',['id'=>$user->id])}}"  class="dropdown-item">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
